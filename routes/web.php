...
;
    Route::post('/email/send', [LawyerController::class, 'sendEmail'])->name('send_email');
    Route::get('/email/verify', [LawyerController::class, 'verifyEmail'])->name('verify_email');

    // Profile Routes  @todo remove id
